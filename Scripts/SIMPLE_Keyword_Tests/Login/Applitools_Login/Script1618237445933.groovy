...
CustomKeywords.'webUI.Login.loginIntoApplication'(SecureGiveURLDEV, SignInNameDEV, SignInPassword)

CustomKeywords.'com.kms.katalon.keyword.applitools.BasicKeywords.checkWindow'('CheckDevLandingPage')

WebUI.openBrowser('')

WebUI.navigateToUrl('https://sg-pre-web.securegive.com/login')
//CustomKeywords.'webUI.Login.loginIntoApplication'(SecureGiveURLDEV, SignInNameDEV, SignInPassword)
CustomKeywords.'webUI.Login.loginIntoApplication'(SecureGiveURLDEV, SignInNamePRE, SignInPassword)

CustomKeywords.'com.kms.katalon.keyword.applitools.BasicKeywords.checkWindow'('CheckPreLandingPage')
