...
if ((ScenarioType == 'Donate_SignIn_Member') || (ScenarioType == 'Donate_SignIn_OrgAdmin')) {
	...
	************************************************/
    ...
    if (OrganizationCount != '1') {
        ...
        CustomKeywords.'webUI.Login.loginIntoApplicationSlug'(GlobalVariable.SecureGiveURL)
    } /*/***********************************************
...
************************************************/
TestObject tObj_PledgeAction = new TestObject('Pledge Action')
...
switch (DonatePurchaseGoal) {
    case 'Donate':
        ...
        //frequency
        custom.WebPages.GivingFrequency(HowOften, Frequency, ChargeOn, DelayedStartMonth, DelayedStartYear, DelayedStartDay, 
    ...
    case 'Goal_Pledge':
        ...
        //Save/Cancel
        TestObject tObj_SaveCancelPledge = new TestObject('Cancel Pledge')
