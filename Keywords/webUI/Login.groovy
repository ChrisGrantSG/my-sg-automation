...
public class Login {
	...
	def static void loginIntoApplication(String applicationURL,String username,String password){
		...
		WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Sign In/button_Sign In'), GlobalVariable.waitPresentTimeout)

		//WebElement element = driver.findElement(findTestObject('Object Repository/Page_Sign In/button_Sign In'))
		//Assert.assertNull(element) //The above assertion will pass if element is not present.

		WebUI.sendKeys(findTestObject('Object Repository/Page_Sign In  SecureGive/input_EmailorPhone'), username)
		WebUI.setEncryptedText(findTestObject('Object Repository/Page_Sign In  SecureGive/input_Password'), password)
		WebUI.click(findTestObject('Object Repository/Page_Sign In  SecureGive/button_Sign In'))
	...
	@Keyword
	def static void loginIntoApplicationSlug(String applicationURL){

		WebUI.openBrowser(applicationURL)
		WebUI.waitForPageLoad(GlobalVariable.waitPresentTimeout)
		WebUI.maximizeWindow()
		//WebUI.waitForElementVisible(findTestObject('Page_Select an Option Below/h5_Select an Option Below'), GlobalVariable.waitPresentTimeout)
	}
}
